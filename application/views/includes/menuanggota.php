...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('dasbot'); ?>"><strong>PERPUSTAKAAN</strong></a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li> 
                                    <a href="<?php echo base_url('lapor/anggota'); ?>"><i class="fa fa-users fa-fw"></i> Data Anggota</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url('lapor/buku'); ?>"><i class="fa fa-book fa-fw"></i> Data Buku</a>
                                </li>
