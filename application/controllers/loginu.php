...
class Login extends CI_Controller {
    ...
    {
        parent::__construct();
        $this->load->model(array('Mod_anggota', 'Mod_buku', 'Mod_login','Mod_loginu' ));
    ...
    public function index()
    {
        if(isset($_POST['proses'])) {
            ...
            {
                $this->load->view('formlogin/view_login_admin');
            }
            else{
                ...
                if($this->Mod_loginu->check_db($username)->num_rows()==1) {

                    //cek verfied bycrpt menyamakan data yg di input dengan ada yg di database 
                    $db = $this->Mod_loginu->check_db($username)->row();
                   ...
                   // if($data) {
                    ...
                    redirect('dashboard');
                        ...
                        $this->load->view('formlogin/view_login_admin', $data);
                    }
