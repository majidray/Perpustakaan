...
class Lapor extends MY_Controller {
    ...
    public function anggota()
    {
        ...
        $this->template->load('leyotbeken', 'laporanggot/anggota_data', $data);
    }

    public function buku()
    {
        $data['buku']      = $this->Mod_buku->getAll();
        $this->template->load('leyotbeken', 'laporanggot/buku_data', $data);
    }

    public function peminjaman()
    {
        $data['title']="Laporan Peminjaman";
        $this->template->load('leyotbeken', 'laporan/peminjaman_data', $data);
    }
    ...
    public function cari_pinjaman()
    {
        ...
        $this->load->view('lapor/peminjaman_search', $data);
    }
    ...
    public function pengembalian()
    {
        ...
        $this->template->load('leyotbeken', 'laporan/pengembalian_data', $data);
    }
